package javaconcurrency.executors;
...
public class CallableDemo {
    ...
    private static class IntegerGenerator implements Callable<Integer> {
        ...
        public Integer call() {
            ...
            log("thread is finished, number = " + number);
            return number; }
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Time of work: " + Duration.between(start, LocalDateTime.now()).getNano() / 1000000
         + " milliseconds");
